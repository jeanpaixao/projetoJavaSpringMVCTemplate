...
<link href="${pageContext.request.contextPath}/resources/plugins/bootstrap-validator/bootstrapValidator.min.css" rel="stylesheet"/>
<!--jVector Map [ OPTIONAL ]-->
<link href="${pageContext.request.contextPath}/resources/plugins/jvectormap/jquery-jvectormap.css" rel="stylesheet"/>
<!--Demo [ DEMONSTRATION ]-->
<link href="${pageContext.request.contextPath}/resources/css/demo/jquery-steps.min.css" rel="stylesheet"/>
<!--Demo [ DEMONSTRATION ]-->
